  ...
  template: `
    <div class="container">
      <mat-card>
        ...
        <mat-card-content>
          <form #ofertaForm="ngForm" (ngSubmit)="crearOferta()">
            <mat-form-field appearance="outline" class="full-width">
              <mat-label>Título</mat-label>
              <input matInput [(ngModel)]="oferta.titulo" name="titulo" required>
            </mat-form-field>

            <mat-form-field appearance="outline" class="full-width">
              <mat-label>Descripción</mat-label>
              <textarea matInput [(ngModel)]="oferta.descripcion" name="descripcion" rows="4" required></textarea>
            </mat-form-field>

            <mat-form-field appearance="outline" class="full-width">
              <mat-label>Requisitos</mat-label>
              <textarea matInput [(ngModel)]="oferta.requisitos" name="requisitos" rows="4" required></textarea>
            </mat-form-field>
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-autocomplete #auto="matAutocomplete" (optionSelected)="seleccionarAtributo($event)">
            ...
            <mat-chip-set class="atributos-chips">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-select [(ngModel)]="oferta.modalidad" name="modalidad" required>
                <mat-option [value]="Modalidad.REMOTO">Remoto</mat-option>
                <mat-option [value]="Modalidad.HIBRIDO">Híbrido</mat-option>
                <mat-option [value]="Modalidad.PRESENCIAL">Presencial</mat-option>
              </mat-select>
            </mat-form-field>

            <mat-form-field appearance="outline" class="full-width">
              <mat-label>Localidad</mat-label>
              <input matInput [(ngModel)]="oferta.locacion" name="locacion" required>
            </mat-form-field>

            <mat-form-field appearance="outline" class="full-width">
              <mat-label>Pago Aproximado (opcional)</mat-label>
              <input matInput [(ngModel)]="oferta.pagoAprox" name="pagoAprox" placeholder="Ej: USD 2000-3000">
            </mat-form-field>
          </form>
        </mat-card-content>
...
export class PublicarOfertaComponent {
  ...
  agregarAtributoEnter(event: Event): void {
    ...
    if (this.atributoInput.trim()) {
      this.atributosService.crearAtributo(this.atributoInput.trim()).subscribe(
        atributo => this.agregarAtributoALista(atributo)
      );
      this.atributoInput = '';
    }
  }
  ...
  crearOferta(): void {
    if (this.oferta.titulo && this.oferta.descripcion && this.oferta.requisitos && 
        this.oferta.modalidad && this.oferta.locacion && this.oferta.atributos.length > 0) {
